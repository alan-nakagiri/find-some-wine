...
RSpec.configure do |config|
  ...
  # Stub RealtimeService (Pusher). Expectations can still be called.
  # config.before(:each) do
  #   allow_any_instance_of(RealtimeService).to receive(:trigger)
  #   allow_any_instance_of(RealtimeService).to receive(:authenticate)
  # end
